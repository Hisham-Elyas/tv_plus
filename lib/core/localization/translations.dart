...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "en": {
          ...
          exitDialogDesc: 'Are you sure you want to exit?',
          yesButton: 'Yes',
          noButton: 'No',
        },
        "ar": {
          exitDialogTitle: 'تأكيد الخروج',
          exitDialogDesc: 'هل أنت متأكد أنك تريد الخروج؟',
          yesButton: 'نعم',
          noButton: 'لا',
          Live: 'مباشر',
          End: 'انتهت',
          ...
          SubscribeToPlan: "اشترك في خطة لفتح الميزات المتميزة",
